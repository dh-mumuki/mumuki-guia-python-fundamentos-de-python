class TestFixtures(unittest.TestCase):
  def un_numero_chico_esiste(self):
    self.assertNotEqual(un_numero_chico, None)
  ...
  def test_es_mayor(self):
    self.assertTrue(es_mayor == (un_numero_grande >= un_numero_chico),'un_numero_grande no pareciera ser mayor que n_numero_chico!')
